...
.box.bg-light.counter-card span, .box.bg-light.counter-card i {
    font-size: 50px;
    top: 0px;
}
a.calendar-btn {
	...
	<body class="hold-transition dark-skin dark-sidebar sidebar-mini theme-yellow">
				...
				<div class="navbar-custom-menu r-side">
					<ul class="nav navbar-nav">
						...
						<li class="dropdown user user-menu">
							...
							{{ URL::to('/storage/app').'/'.Auth::user()->image }}
							@else
							{{ URL::to('/public/admin/assets/user.jpg') }}
							@endif
							...
							@endif" class="float-left rounded-circle" alt="User Image">
								...
								<!-- Menu Body -->
								<li class="user-body">
									<a class="dropdown-item" href="{{ route('users.edit', ['id' => Auth::user()->id]) }}"><i class="ion ion-person"></i> My Profile</a>
					...
					<div class="profile-pic">
						...
						<div class="profile-info">
							...
							<div class="text-center d-inline-block">
								<a href="{{ route('users.edit', ['id' => Auth::user()->id]) }}" class="link" data-toggle="tooltip" title="" data-original-title="Edit Profile"><i class="ion ion-gear-b"></i></a>
								<a href="#" class="link px-15" data-toggle="tooltip" title="" data-original-title="Email"><i class="ion ion-android-mail"></i></a>
								<a href="{{ URL::to('/trade-center/logout') }}" class="link" data-toggle="tooltip" title="" data-original-title="Logout"><i class="ion ion-power"></i></a>
							</div>
						</div>
					</div>
				</div>
				...
				<ul class="sidebar-menu" data-widget="tree">
					...
					<li class="treeview">
						...
						<ul class="treeview-menu">
							<li><a href="{{ URL::to('trade-center/reports/transactions') }}"><i class="ti-more"></i>Transactions History</a></li>
					...
					<li class="treeview">
						...
						<ul class="treeview-menu">
							<li><a href="{{ route('daily.bonus.list') }}"><i class="ti-more"></i>Daily Earning</a></li>
						</ul>
					</li>
					<li class="treeview">
						<a href="#">
                    ...
                    <li class="treeview">
						...
						<ul class="treeview-menu">
                            <li><a href="{{ URL::to('/trade-center/bank') }}"><i class="ti-more"></i>Manage Method</a></li>
                            <li><a href="{{ URL::to('/trade-center/bank/create') }}"><i class="ti-more"></i>Add Method</a></li>
                        </ul>
					</li>
                    <li class="treeview">
						<a href="#">
						...
						<ul class="treeview-menu">
                            <li><a href="{{ URL::to('/trade-center/users') }}"><i class="ti-more"></i>Manage Users</a></li>
                            <li><a href="{{ URL::to('/trade-center/Users/create') }}"><i class="ti-more"></i>Add Users</a></li>
                        </ul>
					</li>
                    ...
                    <li class="treeview">
						...
						<ul class="treeview-menu">
                            <li><a href="{{ URL::to('/trade-center/percentage') }}"><i class="ti-more"></i>Manage Percentage</a></li>
                            <li><a href="{{ URL::to('/trade-center/percentage/percentage-create') }}"><i class="ti-more"></i>Add Percentage</a></li>
                        </ul>
					</li>
					<li class="treeview">
						<a href="#">
						...
						<ul class="treeview-menu">
                            <li><a href="{{ URL::to('/trade-center/sliders') }}"><i class="ti-more"></i>Manage Slider</a></li>
                            <li><a href="{{ URL::to('/trade-center/sliders/create') }}"><i class="ti-more"></i>Add Slider</a></li>
                        </ul>
					</li>
					 @endif
		...
		<div class="content-wrapper">
            ...
            <footer class="main-footer">
				&copy; @php echo date("Y"); @endphp <a href="">Partnershiptraders</a>. All Rights Reserved.
			</footer>
