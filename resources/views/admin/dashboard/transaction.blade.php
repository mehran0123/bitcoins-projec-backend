...
<div class="container-full">
    ...
    <section class="content">
            <div class="box">
               ...
               <!-- /.box-header -->
               <div class="box-body">
                   <form class="report-filter"><select name="method"><option value="">All transaction</option><option value="Deposit">Deposit</option><option value="Withdraw">Withdraw</option></select><input  placeholder="From Date" class="textbox-n" type="text" onfocus="(this.type='date')" name="start"><input placeholder="To Date" class="textbox-n" type="text" onfocus="(this.type='date')" name="end"><input type="submit" value="Search"></form>
                   {{-- <h4 class="box-title">All Transactions</h4> --}}
