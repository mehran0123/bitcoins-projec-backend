    ...
    <section class="content">
            ...
            <div class="col-3">
                <div class="box bg-light counter-card">
                    <div class="box-body text-center">
                        ...
                        <h3>{{$deposits}} <small class="text-light">$</small></h3>
                        <span>$</span>
                    </div>
                </div>
            </div>
            <div class="col-3">
                <div class="box bg-light counter-card">
                    <div class="box-body text-center">
                        ...
                        <h3>0 <small class="text-light">$</small></h3>
                        <span>$</span>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-3">
                <div class="box bg-light counter-card">
                    <div class="box-body text-center">
                        <h4 class="cardscounter">Server Time</h4>
                        <h3 >
                            @php
            ...
            <div class="col-3">
                <div class="box bg-light counter-card">
                    <div class="box-body text-center">
                        <h4 class="cardscounter">Total Earning</h4>
                        <h3>{{ Auth::user()->bonus_points  }} <small class="text-light">$</small></h3>
                        <span>$</span>
            ...
            <div class="col-3">
                <div class="box bg-light counter-card">
                    <div class="box-body text-center">
                        <h4 class="cardscounter">Right Childs</h4>
                        @php 
                        $right_code= Auth::user()->right_code;
                        $left_code= Auth::user()->left_code;
                        $tr_childs= Auth::user()->where('sponcer_by',$right_code)->get();
                        $tl_childs= Auth::user()->where('sponcer_by',$left_code)->get();
                     /* $flag=0;
                      $countl=0;
                      while($flag==0){
                      if(!$tl_childs){
                    ...
                    */
                     @endphp
                        <h3>{{ count($tr_childs) }} <small class="text-light"></small></h3>
                        <i class="fa fa-cubes" aria-hidden="true"></i>
                    </div>
                </div>
            </div>
            <div class="col-3">
                <div class="box bg-light counter-card">
                    <div class="box-body text-center">
                        <h4 class="cardscounter">Left Childs</h4>
                        <h3>{{ count($tl_childs) }} <small class="text-light"></small></h3>
                        <i class="fa fa-cubes" aria-hidden="true"></i>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12">
                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                    ...
                    <ol class="carousel-indicators">
                        ...
                        <li data-target="#carouselExampleIndicators" data-slide-to="{{$slide_c1++}}" class="active"></li>
                    ...
                    <div class="carousel-inner">
                        ...
                        @endif
                            ...
                            <img class="d-block" src="{{ URL::to('/storage/app')."/".$slide->image }}" alt=" slide">
                        </div>
                        @php 
                            $slide_c++;
                        @endphp
               ...
               <div class="col-12">
                    <div class="box p-4 ranks_s">
                        <h2>Ranks & Achivements</h2>
                        <p>Get The Most Points to Achive Ranks and Get Amazing Bonuses</p>
