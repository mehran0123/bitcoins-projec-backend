    ...
    <form method="post" onsubmit="return false">
        ...
        <div class="form-row">
          <div class="col-md-12 mb-3">
              ...
              <input type="number" min="1" max="8" class="form-control" id="percentage" name="percentage" autofocus>
              <small id="percentage_error" class="text-danger"></small>
          </div>
        </div><!-- /.form-row -->
     <hr>
      <button class="btn btn-primary btn-lg btn-block" type="button" id="add_percentage">Add Percentage</button>
