...
@section('content')
    ...
    <div class="page">
        ...
        <div class="page-inner">
            ...
            <div class="card">
                <!-- .card-body -->
                <div class="card-body">
                    <h4 class="card-title"> Create Administration
                    ...
                    <form method="post" onsubmit="return false">
                        <div class="form-row">
                            <div class="col-md-6">
                                ...
                                <select class="form-control" name="user_role" id="user_role">
                                    ...
                                    <option value="6">Acountant</option>
                                </select>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="email" placeholder="Enter User email" class="form-control" id="email">
    ...
    @include('admin.administrations.js.create')
@endsection
