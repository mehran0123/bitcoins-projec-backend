                    ...
                    <form method="post" onsubmit="return false">
                        <div class="form-row">
                            <div class="col-md-6">
                                ...
                                <select class="form-control" name="user_role" id="user_role">
                                    ...
                                    <option value="3" @if ($user->user_role == 3) {{ 'selected' }} @endif>
                                        Admin User</option>
                                    <option value="4" @if ($user->user_role == 4) {{ 'selected' }} @endif>
                                        Standard User</option>
                                    <option value="5" @if ($user->user_role == 5) {{ 'selected' }} @endif>
                                        Basic User</option>
                                    <option value="6" @if ($user->user_role == 6) {{ 'selected' }} @endif>
                                        Acountant</option>
                                </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" placeholder="Enter User Name" value="{{ $user->name }}"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="email" placeholder="Enter User email" value="{{ $user->email }}"
                                    class="form-control" id="email">
                                <small id="email_error" class="text-danger"></small>
                            </div>
                            <div class="col-md-6">
                                <label for="phone">User Phone</label>
                                <input type="number" value="{{ $user->phone }}" placeholder="Enter User phone number"
                        ...
                        <div class="row">
                            <div class="col-md-5 col-lg-5 mb-3">
                                <label for="password">Password<button class="btn btn-success btn-sm" id="generate_password"
                                        style="padding: 2px 12px 2px 12px !important"><span class="fa fa-plus"></span>
                                        Generate</button></label>
                                <input type="password" value="{{ $user->c_password }}" class="form-control" name="password"
                                    id="password" placeholder="Enter password" autofocus />
                                <span class="form-text text-danger" id="password_error"></span>
                            </div>
                            <div class="col-md-5 col-lg-5 mb-3">
                                <label for="confirm_password">Confirm Password</label>
                                <input type="password" class="form-control" value="{{ $user->c_password }}"
