    ...
    <form method="post" onsubmit="return false">
        ...
        <div class="form-row">
          <div class="col-md-6 mb-3">
              ...
              <input type="number" class="form-control" id="withdraw_amount" name="withdraw_amount" autofocus>
     ...
     <hr>
      <button class="btn btn-primary btn-lg btn-block" type="button" id="add_withdraw">Add Withdraw Record</button>
