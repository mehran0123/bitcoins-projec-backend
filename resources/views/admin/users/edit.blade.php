                ...
                <form method="post" onsubmit="return false">
                    <div class="form-row">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" placeholder="Enter Last Name" value="{{ $user->last_name }}"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" value="{{ $user->id_card_number }}" placeholder="Enter CNIC number"
                                class="form-control" id="cnic_number">
                    ...
                    <div class="row mt-2">
                        <div class="col-md-5 col-lg-5 mb-3">
                            ...
                            <input type="password" class="form-control" value="{{ $user->real_password }}" name="password"
                                id="password" placeholder="Enter password" autofocus />
                            <span class="form-text text-danger" id="password_error"></span>
                        </div>
                        <div class="col-md-5 col-lg-5 mb-3">
                            <label for="confirm_password">Confirm Password</label>
                            <input type="password" class="form-control" value="{{ $user->real_password }}"
                        ...
                        <div class="group-contain" style="display: flex;">
                            ...
                            <div class="form-group" style="display: block;margin: 0 auto;">
                                <div id="uploadList" class="list-group list-group-flush list-group-divider"
                                    style="margin: auto;">
                                    <img src="{{ asset('/storage/app') }}/{{ $user->image }}" alt="Preview Image"
                                        id="blah-one" height="100px">
                                </div>
                            </div>
                        </div>
                        <!-- /.form-group -->
