...
<header class="page-title-bar">
  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <a href="{{ route('sliders.list') }}" class="btn btn-primary text-white btn-sm pull-right float-right">@lang('translation.back')</a>
    ...
    <form method="post" onsubmit="return false">
                ...
                <div class="group-contain" style="
                   ...
                   <div class="form-group" style="display: block;margin: 0 auto;">
                      <div id="uploadList" class="list-group list-group-flush list-group-divider" style="margin: auto;">
                        <img src="{{ asset('/storage/app') }}/{{ $slider->image }}" alt="Preview Image" id="blah-one" height="100px">
                      </div>
                   </div>
                </div>
                <!-- /.form-group -->
     ...
     <hr>
      <button class="btn btn-primary btn-lg btn-block" type="button" id="edit_slider">Edit Slider</button>
    </form><!-- /form .needs-validation -->
    </div><!-- /.card-body -->
  </div>
    </div></div>
    @include('admin.sliders.js.edit')
    @endsection
