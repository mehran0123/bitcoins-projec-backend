    ...
    <div class="page">
        ...
        <div class="page-inner">
            <header class="page-title-bar">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('bank.list') }}">Transaction Methods Settings</a>
                        </li>
            ...
            <div class="card">
                <!-- .card-body -->
                <div class="card-body">
                    <h4 class="card-title"> Add Transaction Methods
                    ...
                    <form method="post" onsubmit="return false">
                        <div class="form-row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" id="account_title" placeholder="Enter Account Title"
                                    class="form-control" />
                        ...
                        <div class="row">
                            <div class="col-md-6 mt-2">
                                ...
                                <input type="number" placeholder="Enter your account no" class="form-control"
                                    id="account_no">
                                <small id="account_no_error" class="text-danger"></small>
                            </div>
                            <div class="col-md-6 mt-2">
                                <label for="transection_fee">Transection Fee</label>
                                <input type="number" placeholder="Enter transection fee" class="form-control"
                                    id="transection_fee">
