...
<body style="overflow:hidden;">
    ...
    <main class="auth" style="/*background-image: url({{ URL::to('/public/admin/assets/images/bg.gif') }});*/">
        ...
        <form action="{{ URL::to('/admin/login-pro') }}" method="POST" class="auth-form">
            ...
            <div class="form-group">
                <div class="form-label-group">
                    <input type="email" id="inputUser" class="form-control" name="email"
                        placeholder="@lang('translation.email')" autofocus="" required /> <label for="inputEmail">Email</label>
                </div>
            </div><!-- /.form-group -->
            <!-- .form-group -->
            <div class="form-group">
                <div class="form-label-group">
                    <input type="password" id="inputPassword" class="form-control" name="password"
                        placeholder="@lang('translation.password')" required /> <label for="inputPassword">Password</label>
                </div>
            </div><!-- /.form-group -->
            <!-- .form-group -->
            <div class="form-group">
            ...
            <div class="form-group text-left">
                <div class="custom-control custom-control-inline custom-checkbox">
                    <input type="checkbox" class="custom-control-input" id="remember-me"> <label
                        class="custom-control-label" for="remember-me">@lang('translation.keep_me_sign_in')</label>
                </div>
            </div><!-- /.form-group -->
            <!--recovery links -->
            <div class="text-center pt-3">
                <span class="mx-2">·</span> <a href="{{ URL::to('/admin/forgot-password') }}"
                    class="link">@lang('translation.forgot_password')</a>
            </div><!-- /recovery links -->
        </form><!-- /.auth-form -->
