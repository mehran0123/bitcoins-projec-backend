                    ...
                    <form method="post" onsubmit="return false">
                        ...
                        <div class="form-row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select id="bank_id" class="form-control">
                                    ...
                                    @foreach ($banks as $bank)
                                        <option value="{{ $bank->id }}" @if ($deposit->bank_id == $bank->id)  @endif>
                                            {{ $bank->type }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control" value="{{ $deposit->amount }}"
                                    id="deposit_amount" name="deposit_amount" autofocus>
                  ...
                  <input id="slip-image" type="file" name="file-one" accept="image/*">
                                ...
                                <div class="form-group" style="display: block; margin: 0 auto;">
                                    <div id="uploadList" class="list-group list-group-flush list-group-divider"
                                        style="margin: auto;">
                                        <img src="{{ asset('/storage/app') }}/{{ $deposit->slip }}" alt="Preview Image"
                                            id="blah-one" class="d-block" width="100">
                                    </div>
                                </div>
                            </div>
                            <!-- /.form-group -->
