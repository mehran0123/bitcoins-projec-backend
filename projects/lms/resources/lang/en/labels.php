...
<b>Live</b> = Will be used with you Live PayUMoney credentials to make actual transaction with normal users with PayUMoney account.<br><strong>If you set this payment gateway then set your currency as INR</strong>',
    ...
    array (
      ...
      array (
        ...
        'drivinglicence' => 'Driver'."'".'s licence including foreign licences',
        'centrallinkcard' => 'Centrelink Card.',
        'securitylicence' => 'Security licence (OCBA) ',
        'pseid' => 'Public Service Employee ID Card',
        'tertiaryid' => 'Tertiary education ID card',
        'proofage' => 'Proof of Age Card',
        'medicare' => 'Medicare Card',
        'others' => 'Others',
        'qualified' => 'Qualified teacher',
        'qualifiedid' => 'Qualified teacher registration number',
      ),
      'title' => 'Teachers',
