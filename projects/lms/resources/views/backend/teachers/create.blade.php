        ...
        <div class="card-body">
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="form-group row">
                        {{ html()->label(__('labels.backend.teachers.fields.dob'))->class('col-md-2 form-control-label')->for('dob') }}

                        <div class="col-md-10">
                            {{ html()->date('dob')
                                ->class('form-control')
                                ->placeholder(__('labels.backend.teachers.fields.dob'))
                                ->attribute('maxlength', 191)
                                ->required() }}
                        </div><!--col-->
                    </div><!--form-group-->
                    ...
                    <div class="form-group row">
                        <label  class="col-md-2 form-control-label"><strong>ID Documents</strong></label>
                    </div>
                    <div class="form-group row">
                       <label class="col-md-2 form-control-label"> <small>( ID Types )</small></label>
                    </div>
                    <div class="form-group row">
                        
                        {{ html()->label(__('labels.backend.teachers.fields.passport'))->class('col-md-2 form-control-label')->for('passport') }}
                        
                        <div class="col-md-10">
                            {!! Form::file('passport', ['class' => 'form-control d-inline-block', 'placeholder' => '']) !!}
                        </div><!--col-->
                    </div>
                    <div class="form-group row">
                    
                        {{ html()->label(__('labels.backend.teachers.fields.birthcertificate'))->class('col-md-2 form-control-label')->for('birthcertificate') }}
                        
                        <div class="col-md-10">
                            {!! Form::file('birthcertificate', ['class' => 'form-control d-inline-block', 'placeholder' => '']) !!}
                        </div><!--col-->
                    </div>
                    <div class="form-group row">
                    
                        {{ html()->label(__('labels.backend.teachers.fields.citizenship'))->class('col-md-2 form-control-label')->for('citizenship') }}
                        
                        <div class="col-md-10">
                            {!! Form::file('citizenship', ['class' => 'form-control d-inline-block', 'placeholder' => '']) !!}
                        </div><!--col-->
                    </div>
                    <div class="form-group row">
                        
                        {{ html()->label(__('labels.backend.teachers.fields.drivinglicence'))->class('col-md-2 form-control-label')->for('drivinglicence') }}
                        
                        <div class="col-md-10">
                            {!! Form::file('drivinglicence', ['class' => 'form-control d-inline-block', 'placeholder' => '']) !!}
                        </div><!--col-->
                    </div>
                    <div class="form-group row">
                    
                        {{ html()->label(__('labels.backend.teachers.fields.centrallinkcard'))->class('col-md-2 form-control-label')->for('centrallinkcard') }}
                        
                        <div class="col-md-10">
                            {!! Form::file('centrallinkcard', ['class' => 'form-control d-inline-block', 'placeholder' => '']) !!}
                        </div><!--col-->
                    </div>
                    <div class="form-group row">
                    
                        {{ html()->label(__('labels.backend.teachers.fields.pseid'))->class('col-md-2 form-control-label')->for('pseid') }}
                        
                        <div class="col-md-10">
                            {!! Form::file('pseid', ['class' => 'form-control d-inline-block', 'placeholder' => '']) !!}
                        </div><!--col-->
                    </div>
                    <div class="form-group row">
                    
                        {{ html()->label(__('labels.backend.teachers.fields.securitylicence'))->class('col-md-2 form-control-label')->for('securitylicence') }}
                        
                        <div class="col-md-10">
                            {!! Form::file('securitylicence', ['class' => 'form-control d-inline-block', 'placeholder' => '']) !!}
                        </div><!--col-->
                    </div>
                    
                    <div class="form-group row">
                    
                        {{ html()->label(__('labels.backend.teachers.fields.tertiaryid'))->class('col-md-2 form-control-label')->for('tertiaryid') }}
                        
                        <div class="col-md-10">
                            {!! Form::file('tertiaryid', ['class' => 'form-control d-inline-block', 'placeholder' => '']) !!}
                        </div><!--col-->
                    </div>
                    <div class="form-group row">
                    
                        {{ html()->label(__('labels.backend.teachers.fields.proofage'))->class('col-md-2 form-control-label')->for('proofage') }}
                        
                        <div class="col-md-10">
                            {!! Form::file('proofage', ['class' => 'form-control d-inline-block', 'placeholder' => '']) !!}
                        </div><!--col-->
                    </div>
                    <div class="form-group row">
                    
                        {{ html()->label(__('labels.backend.teachers.fields.medicare'))->class('col-md-2 form-control-label')->for('medicare') }}
                        
                        <div class="col-md-10">
                            {!! Form::file('medicare', ['class' => 'form-control d-inline-block', 'placeholder' => '']) !!}
                        </div><!--col-->
                    </div>
                    <div class="form-group row">
                    
                        {{ html()->label(__('labels.backend.teachers.fields.others'))->class('col-md-2 form-control-label')->for('others') }}
                        
                        <div class="col-md-10">
                            {!! Form::file('others', ['class' => 'form-control d-inline-block', 'placeholder' => '']) !!}
                        </div><!--col-->
                    </div>
                    <div class="form-group row">
                        {{ html()->label(__('labels.backend.teachers.fields.qualified'))->class('col-md-2 form-control-label')->for('qualified') }}
                        <div class="col-md-10">
                            {{ html()->label(html()->checkbox('')->name('qualified')
                        ...
                        {{ html()->label(__('labels.backend.teachers.fields.qualifiedid'))->class('col-md-2 form-control-label')->for('qualifiedid') }}
                        <div class="col-md-10">
                            {{ html()->label(html()->checkbox('')->name('qualifiedid')
                                        ->checked(true)->class('switch-input')->value(1)
